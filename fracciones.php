...
<head>
    ...
    <title>Artículo 29 | CAPDAM</title>
</head>    
<body id="main">
    ...
    <div class="container">
        <div class="row">
            ...
            ?>
                        <blockquote><h2>Fracción I. Marco normativo </h2></blockquote>
                        <div id="titulo_directorio">Nivel nacional</div>
                        <table class="striped responsive-table">
                            ...
                            <tbody>
                                <script>
                                    var archivos = [
                                        ['Constitución Política De Los Estados Unidos Mexicanos','constitucion_politica_de_los_estados_unidos_mexicanos.pdf'],
                                        ['Ley De Aguas Nacionales','ley_de_aguas_nacionales.pdf'],
                                        ['Ley Del Impuesto Al Valor Agregado','ley_del_impuesto_al_valor_agregado.pdf'],
                                        ['Ley De Adquisiciones, Arrendamientos Y Servicios Del Sector Público','no disponible'],
                                        ['Ley De Obras Públicas Y Servicios Relacionados Con Las Mismas','ley_de_obras_publicas_y_servicios_relacionados_con_las_mismas.pdf'],
                                        ['Ley Federal De Transparencia Y Acceso A La Información Pública','ley_federal_de_transparencia_y_acceso_a_la_informacion_publica.pdf'],
                                        ['Ley General De Protección De Datos Personales En Posesión De Sujetos Obligados','ley_general_de_proteccion_de_datos_personales_en_posesion_de_sujetos_obligados.pdf'],
                                        ['Ley De Disciplina Financiera De Las Entidades Federativas Y Los Municipios','ley_de_disciplina_financiera_de_las_entidades_federativas_y_los_municipios.pdf'],
                                        ['Ley General De Contabilidad Gubernamental','ley_general_de_contabilidad_gubernamental.pdf'],
                                        ['Ley Federal Del Trabajo','ley_federal_del_trabajo.pdf'],
                                        ['Ley Federal De Los Trabajadores Al Servicio Del Estado, Reglamentaria Del Apartado B Del Art. 123 Constitucional','ley_federal_de_los_trabajadores_al_servicio_del_estado_reglamentaria_del_apartado_b_del_art_123_constitucional.pdf'],
                                        ['Ley General De Responsabilidades Administrativas','ley_general_de_responsabilidades_administrativas.pdf']
                                    ];  
                        ...
                        <div id="titulo_directorio">Nivel local</div>
                        <table class="striped responsive-table">
                            <thead>
                                <tr>
                                    <th>Documento</th>
                            ...
                            <tbody>
                                <script>
                                    var archivos = [
                                        ['Constitución Política Del Estado Libre Y Soberano De Colima','constitucion_politica_del_estado_libre_y_soberano_de_colima.pdf'],
                                        ['Ley Que Establece Las Cuotas Para El Pago De Derechos Por Los Servicios Públicos De Agua Potable, Alcantarillado Y Saneamiento De Manzanillo, Colima','ley_que_establece_las_cuotas_para_el_pago_de_derechos_por_los_servicios_publicos_de_agua_potable_alcantarillado_y_saneamiento_de_manzanillo_colima.pdf'],
                                        ['Ley De Aguas Para El Estado De Colima','ley_de_aguas_para_el_estado_de_colima.pdf'],
                                        ['Ley De Transparencia Y Acceso A La Información Pública Del Estado De Colima','ley_de_transparencia_y_acceso_a_la_informacion_publica_del_estado_de_colima.pdf'],
                                        ['Ley De Adquisiciones, Servicios Y Arrendamientos Del Sector Público Del Estado De Colima','ley_de_adquisiciones_servicios_y_arrendamientos_del_sector_publico_del_estado_de_colima.pdf'],
                                        ['Ley Estatal De Obras Públicas','ley_estatal_de_obras_publicas.pdf'],
                                        ['Ley De Responsabilidad Patrimonial Del Estado De Colima','ley_de_responsabilidad_patrimonial_del_estado_de_colima.pdf'],
                                        ['Ley De Justicia Administrativa Del Estado De Colima','ley_de_justicia_administrativa_del_estado_de_colima.pdf'],
                                        ['Ley De Protección De Datos Personales En Posesión De Sujetos Obligados Para El Estado De Colima','ley_de_proteccion_de_datos_personales_en_posesion_de_sujetos_obligados_para_el_estado_de_colima.pdf'],
                                        ['Ley De Los Trabajadores Al Servicio Del Gobierno, Ayuntamientos Y Organismos Descentralizados Del Estado De Colima','ley_de_los_trabajadores_al_servicio_del_gobierno_ayuntamientos_y_organismos_descentralizados_del_estado_de_colima.pdf'],
                                    ];  
                                    for(var i=0; i<=(archivos.length); i++){
                                        document.write(
                                            '<tr>'+
                        ...
                        <div id="titulo_directorio">Reglamentos</div>
                        <table class="striped responsive-table">
                            <thead>
                                <tr>
                                    <th>Documento</th>
                            ...
                            <tbody>
                                <script>
                                    var archivos = [
                                        ['Reglamento Interior De La CAPDAM','reglamento_interior_de_la_capdam.pdf'],
                                        ['Código De Conducta De La CAPDAM','codigo_de_conducta_de_la_capdam.pdf'],
                                        ['Código De Ética De La CAPDAM','codigo_de_etica_de_la_capdam.pdf'],
                                        ['Reglamento Para La Administración Y Operación De Vehículos Oficiales De La CAPDAM','reglamento_para_la_administracion_y_operacion_de_vehiculos_oficiales_de_la_capdam.pdf'],
                                        ['Reglamento De Bienes Patrimoniales De La CAPDAM','reglamento_de_bienes_patrimoniales_de_la_capdam.pdf'],
                                        ['Manual De Organización De La CAPDAM','manual_de_organizacion_de_la_capdam.pdf']
                                    ];  
                                    for(var i=0; i<=(archivos.length); i++){
                                        document.write(
                                            '<tr>'+
                                                '<td id="td1_1">'+archivos[i][0]+'</td>'+
                                                '<td id="td2_2">'+
                                                    '<center><a download="'+archivos[i][0]+'" href="archivos/seccion_transparencia/articulo_29/fraccion_1/reglamentos/'+archivos[i][1]+'"><img src="images/iconos/icon_descargar.png" style="width:25px"></a></center>'+
                                                '</td>'+
                                                '<td id="td3_3">'+
                                                    '<center>'+
                                            ...
                                            '<div id="modal__'+(i+1)+'" class="modal modal-fixed-footer">'+
                                                '<div class="modal-content">'+
                                                    '<blockquote><h2>'+archivos[i][0]+'</h2></blockquote>'+
                                                    '<embed src="archivos/seccion_transparencia/articulo_29/fraccion_1/reglamentos/'+archivos[i][1]+'" type="application/pdf" style="width:100%; height: 500px;" />'+
                                                '</div>'+
                                                '<div class="modal-footer">'+
                                                    '<a style="color:white" class="modal-close w3-btn w3-block middleblue">Cerrar <img style="width:20px;vertical-align:middle;" src="images/iconos/icon_cerrar.png"></a>'+
                                                '</div>'+
            ...
            <?php                       
                    ...
                    case 2:
            ?>
                        <blockquote><h2>Fracción II. Estructura Orgánica</h2></blockquote>
                        <table class="striped responsive-table">
                            <thead>
                                <tr>
                                    <th>Documento</th>
                            ...
                            <tbody>
                                <script>
                                    var archivos = [
                                        ['Estructura Orgánica','estructura_organica.pdf'],
                                    ...
                                    for(var i=0; i<=(archivos.length); i++){
                                        document.write(
                                            '<tr>'+
                                                '<td id="td1_1">'+archivos[i][0]+'</td>'+
                                                '<td id="td2_2">'+
                                                    '<center><a download="'+archivos[i][0]+'" href="archivos/seccion_transparencia/articulo_29/fraccion_2/'+archivos[i][1]+'"><img src="images/iconos/icon_descargar.png" style="width:25px"></a></center>'+
                                                '</td>'+
                                                '<td id="td3_3">'+
                                                    '<center>'+
                                                        '<a href="#modal'+(i+1)+'" class="modal-trigger"><img src="images/iconos/icon_ver.png" style="width:25px"</a>'+
                                            ...
                                            '<div id="modal'+(i+1)+'" class="modal modal-fixed-footer">'+
                                                '<div class="modal-content">'+
                                                    '<blockquote><h2>'+archivos[i][0]+'</h2></blockquote>'+
                                                    '<embed src="archivos/seccion_transparencia/articulo_29/fraccion_2/'+archivos[i][1]+'" type="application/pdf" style="width:100%; height: 500px;" />'+
                                                '</div>'+
                                                '<div class="modal-footer">'+
                                                    '<a style="color:white" class="modal-close w3-btn w3-block middleblue">Cerrar <img style="width:20px;vertical-align:middle;" src="images/iconos/icon_cerrar.png"></a>'+
                                                '</div>'+
            ...
            <?php
                    ...
                    case 3:
            ?>
                        <blockquote><h2>Fracción III. Facultades De Cada Área</h2></blockquote>
                        <i>Las Facultades De Cada Área</i><br><br>
                            ...
                            <tbody>
                                <script>
                                    var archivos = [
                                        ...
                                        ['Secretario Particular','secretario_particular.pdf'],
                                        ['Asistente De Dirección General','asistente_de_direccion_general.pdf'],
                                        ['Departamento Jurídico','departamento_juridico.pdf'],
                                        ['Departamento Transparencia','departamento_transparencia.pdf'],
                                        ['Departamento Atención A Usuarios','departamento_atencion_a_usuarios.pdf'],
                                    ...
                                    for(var i=0; i<=(archivos.length); i++){
                                        document.write(
                                            '<tr>'+
                                                '<td id="td1_1">'+archivos[i][0]+'</td>'+
                                                '<td id="td2_2">'+
                                                    '<center><a download="'+archivos[i][0]+'" href="archivos/seccion_transparencia/articulo_29/fraccion_3/direccion_general/'+archivos[i][1]+'"><img src="images/iconos/icon_descargar.png" style="width:25px"></a></center>'+
                                                '</td>'+
                                                '<td id="td3_3">'+
                                                    '<center>'+
                                                        '<a href="#f3_1_modal'+(i+1)+'" class="modal-trigger"><img src="images/iconos/icon_ver.png" style="width:25px"</a>'+
                                                    '</center>'+
                                                '</td>'+
                                            '</tr>'+
                                            '<div id="f3_1_modal'+(i+1)+'" class="modal modal-fixed-footer">'+
                                                '<div class="modal-content">'+
                                                    '<blockquote><h2>'+archivos[i][0]+'</h2></blockquote>'+
                                                    '<embed src="archivos/seccion_transparencia/articulo_29/fraccion_3/direccion_general/'+archivos[i][1]+'" type="application/pdf" style="width:100%; height: 500px;" />'+
                                                '</div>'+
                                                '<div class="modal-footer">'+
                                                    '<a style="color:white" class="modal-close w3-btn w3-block middleblue">Cerrar <img style="width:20px;vertical-align:middle;" src="images/iconos/icon_cerrar.png"></a>'+
                                                '</div>'+
                                    ...
                                    for(var i=0; i<=(archivos.length); i++){
                                        document.write(
                                            '<tr>'+
                                                '<td id="td1_1">'+archivos[i][0]+'</td>'+
                                                '<td id="td2_2">'+
                                                    '<center><a download="'+archivos[i][0]+'" href="archivos/seccion_transparencia/articulo_29/fraccion_3/direccion_de_contraloria/'+archivos[i][1]+'"><img src="images/iconos/icon_descargar.png" style="width:25px"></a></center>'+
                                                '</td>'+
                                                '<td id="td3_3">'+
                                                    '<center>'+
                                                        '<a href="#f3_2_modal'+(i+1)+'" class="modal-trigger"><img src="images/iconos/icon_ver.png" style="width:25px"</a>'+
                                                    '</center>'+
                                                '</td>'+
                                            '</tr>'+
                                            '<div id="f3_2_modal'+(i+1)+'" class="modal modal-fixed-footer">'+
                                                '<div class="modal-content">'+
                                                    '<blockquote><h2>'+archivos[i][0]+'</h2></blockquote>'+
                                                    '<embed src="archivos/seccion_transparencia/articulo_29/fraccion_3/direccion_de_contraloria/'+archivos[i][1]+'" type="application/pdf" style="width:100%; height: 500px;" />'+
                                                '</div>'+
                                                '<div class="modal-footer">'+
                                                    '<a style="color:white" class="modal-close w3-btn w3-block middleblue">Cerrar <img style="width:20px;vertical-align:middle;" src="images/iconos/icon_cerrar.png"></a>'+
                                                '</div>'+
                            ...
                            <tbody>
                                <script>
                                    var archivos = [
                                        ...
                                        ['Asistente Comercial','asistente_comercial.pdf'],
                                        ['Departamento De Medición','departamento_de_medicion.pdf'],
                                        ['Departamento De Cobranza Y Cartera Vencida','departamento_de_cobranza_y_cartera_vencida.pdf'],
                                        ['Notificaciones','notificaciones.pdf'],
                                        ['Inspecciones','inspecciones.pdf'],
                                        ['Ejecución Y Embargo','ejecucion_y_embargo.pdf'],
                                        ['Cortes Y Reconexiones','cortes_y_reconexiones.pdf'],
                                    ...
                                    for(var i=0; i<=(archivos.length); i++){
                                        document.write(
                                            '<tr>'+
                                                '<td id="td1_1">'+archivos[i][0]+'</td>'+
                                                '<td id="td2_2">'+
                                                    '<center><a download="'+archivos[i][0]+'" href="archivos/seccion_transparencia/articulo_29/fraccion_3/direccion_comercial/'+archivos[i][1]+'"><img src="images/iconos/icon_descargar.png" style="width:25px"></a></center>'+
                                                '</td>'+
                                                '<td id="td3_3">'+
                                                    '<center>'+
                                                        '<a href="#f3_3_modal'+(i+1)+'" class="modal-trigger"><img src="images/iconos/icon_ver.png" style="width:25px"</a>'+
                                                    '</center>'+
                                                '</td>'+
                                            '</tr>'+
                                            '<div id="f3_3_modal'+(i+1)+'" class="modal modal-fixed-footer">'+
                                                '<div class="modal-content">'+
                                                    '<blockquote><h2>'+archivos[i][0]+'</h2></blockquote>'+
                                                    '<embed src="archivos/seccion_transparencia/articulo_29/fraccion_3/direccion_comercial/'+archivos[i][1]+'" type="application/pdf" style="width:100%; height: 500px;" />'+
                                                '</div>'+
                                                '<div class="modal-footer">'+
                                                    '<a style="color:white" class="modal-close w3-btn w3-block middleblue">Cerrar <img style="width:20px;vertical-align:middle;" src="images/iconos/icon_cerrar.png"></a>'+
                                                '</div>'+
                            ...
                            <tbody>
                                <script>
                                    var archivos = [
                                        ...
                                        ['Asistente Administrativa','asistente_administrativa.pdf'],
                                        ['Departamento De Recursos Humanos','departamento_de_recursos_humanos.pdf'],
                                        ['Departamento De Evaluación De Personal','departamento_de_evaluacion_de_personal.pdf'],
                                        ['Departamento De Seguridad E Higiene','departamento_de_seguridad_e_higiene.pdf'],
                                        ...
                                        ['Departamento De Taller Mecánico','departamento_de_taller_mecanico.pdf']
                                    ];  
                                    for(var i=0; i<=(archivos.length); i++){
                                        document.write(
                                            '<tr>'+
                                                '<td id="td1_1">'+archivos[i][0]+'</td>'+
                                                '<td id="td2_2">'+
                                                    '<center><a download="'+archivos[i][0]+'" href="archivos/seccion_transparencia/articulo_29/fraccion_3/direccion_administrativa/'+archivos[i][1]+'"><img src="images/iconos/icon_descargar.png" style="width:25px"></a></center>'+
                                                '</td>'+
                                                '<td id="td3_3">'+
                                                    '<center>'+
                                                        '<a href="#f3_4_modal'+(i+1)+'" class="modal-trigger"><img src="images/iconos/icon_ver.png" style="width:25px"</a>'+
                                                    '</center>'+
                                                '</td>'+
                                            '</tr>'+
                                            '<div id="f3_4_modal'+(i+1)+'" class="modal modal-fixed-footer">'+
                                                '<div class="modal-content">'+
                                                    '<blockquote><h2>'+archivos[i][0]+'</h2></blockquote>'+
                                                    '<embed src="archivos/seccion_transparencia/articulo_29/fraccion_3/direccion_administrativa/'+archivos[i][1]+'" type="application/pdf" style="width:100%; height: 500px;" />'+
                                                '</div>'+
                                                '<div class="modal-footer">'+
                                                    '<a style="color:white" class="modal-close w3-btn w3-block middleblue">Cerrar <img style="width:20px;vertical-align:middle;" src="images/iconos/icon_cerrar.png"></a>'+
                                                '</div>'+
                        ...
                        <table class="striped responsive-table">
                            ...
                            <tbody>
                                <script>
                                    var archivos = [
                                        ['Director De Finanzas','director_de_finanzas.pdf'],
                                        ['Asistente De Finanzas','asistente_de_finanzas.pdf'],
                                        ['Departamento De Asuntos Fiscales','departamento_de_asuntos_fiscales.pdf'],
                                        ['Departamento De Facturación Y Operación De Caja','departamento_de_facturacion_y_operacion_de_caja.pdf'],
                                    ...
                                    for(var i=0; i<=(archivos.length); i++){
                                        document.write(
                                            '<tr>'+
                                                '<td id="td1_1">'+archivos[i][0]+'</td>'+
                                                '<td id="td2_2">'+
                                                    '<center><a download="'+archivos[i][0]+'" href="archivos/seccion_transparencia/articulo_29/fraccion_3/direccion_de_finanzas/'+archivos[i][1]+'"><img src="images/iconos/icon_descargar.png" style="width:25px"></a></center>'+
                                                '</td>'+
                                                '<td id="td3_3">'+
                                                    '<center>'+
                                                        '<a href="#f3_5_modal'+(i+1)+'" class="modal-trigger"><img src="images/iconos/icon_ver.png" style="width:25px"</a>'+
                                                    '</center>'+
                                                '</td>'+
                                            '</tr>'+
                                            '<div id="f3_5_modal'+(i+1)+'" class="modal modal-fixed-footer">'+
                                                '<div class="modal-content">'+
                                                    '<blockquote><h2>'+archivos[i][0]+'</h2></blockquote>'+
                                                    '<embed src="archivos/seccion_transparencia/articulo_29/fraccion_3/direccion_de_finanzas/'+archivos[i][1]+'" type="application/pdf" style="width:100%; height: 500px;" />'+
                                                '</div>'+
                                                '<div class="modal-footer">'+
                                                    '<a style="color:white" class="modal-close w3-btn w3-block middleblue">Cerrar <img style="width:20px;vertical-align:middle;" src="images/iconos/icon_cerrar.png"></a>'+
                                                '</div>'+
                            ...
                            <tbody>
                                <script>
                                    var archivos = [
                                        ...
                                        ['Departamento De Instalaciones Y Redes','departamento_de_instalaciones_y_redes.pdf'],
                                        ['Delegación “Santiago”','delegacion_santiago.pdf'],
                                    ...
                                    for(var i=0; i<=(archivos.length); i++){
                                        document.write(
                                            '<tr>'+
                                                '<td id="td1_1">'+archivos[i][0]+'</td>'+
                                                '<td id="td2_2">'+
                                                    '<center><a download="'+archivos[i][0]+'" href="archivos/seccion_transparencia/articulo_29/fraccion_3/direccion_de_operacion/'+archivos[i][1]+'"><img src="images/iconos/icon_descargar.png" style="width:25px"></a></center>'+
                                                '</td>'+
                                                '<td id="td3_3">'+
                                                    '<center>'+
                                                        '<a href="#f3_6_modal'+(i+1)+'" class="modal-trigger"><img src="images/iconos/icon_ver.png" style="width:25px"</a>'+
                                                    '</center>'+
                                                '</td>'+
                                            '</tr>'+
                                            '<div id="f3_6_modal'+(i+1)+'" class="modal modal-fixed-footer">'+
                                                '<div class="modal-content">'+
                                                    '<blockquote><h2>'+archivos[i][0]+'</h2></blockquote>'+
                                                    '<embed src="archivos/seccion_transparencia/articulo_29/fraccion_3/direccion_de_operacion/'+archivos[i][1]+'" type="application/pdf" style="width:100%; height: 500px;" />'+
                                                '</div>'+
                                                '<div class="modal-footer">'+
                                                    '<a style="color:white" class="modal-close w3-btn w3-block middleblue">Cerrar <img style="width:20px;vertical-align:middle;" src="images/iconos/icon_cerrar.png"></a>'+
                                                '</div>'+
                            ...
                            <tbody>
                                <script>
                                    var archivos = [
                                        ...
                                        ['Topógrafo','topografo.pdf'],
                                        ['Ayudante','ayudante.pdf'],
                                        ['Departamento De Licitaciones Y Contratos','departamento_de_licitaciones_y_contratos.pdf'],
                                        ['Departamento De Ingeniería','departamento_de_ingenieria.pdf'],
                                        ['Supervisión De Obra','supervision_de_obra.pdf'],
                                        ['Conformación Y Elaboración De Expedientes','conformacion_y_elaboracion_de_expedientes.pdf']
                                    ];  
                                    for(var i=0; i<=(archivos.length); i++){
                                        document.write(
                                            '<tr>'+
                                                '<td id="td1_1">'+archivos[i][0]+'</td>'+
                                                '<td id="td2_2">'+
                                                    '<center><a download="'+archivos[i][0]+'" href="archivos/seccion_transparencia/articulo_29/fraccion_3/direccion_de_construccion/'+archivos[i][1]+'"><img src="images/iconos/icon_descargar.png" style="width:25px"></a></center>'+
                                                '</td>'+
                                                '<td id="td3_3">'+
                                                    '<center>'+
                                                        '<a href="#f3_7_modal'+(i+1)+'" class="modal-trigger"><img src="images/iconos/icon_ver.png" style="width:25px"</a>'+
                                                    '</center>'+
                                                '</td>'+
                                            '</tr>'+
                                            '<div id="f3_7_modal'+(i+1)+'" class="modal modal-fixed-footer">'+
                                                '<div class="modal-content">'+
                                                    '<blockquote><h2>'+archivos[i][0]+'</h2></blockquote>'+
                                                    '<embed src="archivos/seccion_transparencia/articulo_29/fraccion_3/direccion_de_construccion/'+archivos[i][1]+'" type="application/pdf" style="width:100%; height: 500px;" />'+
                                                '</div>'+
                                                '<div class="modal-footer">'+
                                                    '<a style="color:white" class="modal-close w3-btn w3-block middleblue">Cerrar <img style="width:20px;vertical-align:middle;" src="images/iconos/icon_cerrar.png"></a>'+
                                                '</div>'+
            ...
            <?php                       
                    ...
                    case 4:
            ?>          
                        <blockquote><h2>Fracción IV. Metas Y Objetivos</h2></blockquote>
                        <table class="striped responsive-table">
                            <thead>
                                <tr>
                                    <th>Documento</th>
                            ...
                            <tbody>
                                <script>
                                    var archivos = [
                                        ['Metas Y Objetivos','metas_y_objetivos.pdf']
                                    ];  
                                    for(var i=0; i<=(archivos.length); i++){
                                        document.write(
                                            '<tr>'+
                                                '<td id="td1_1">'+archivos[i][0]+'</td>'+
                                                '<td id="td2_2">'+
                                                    '<center><a download="'+archivos[i][0]+'" href="archivos/seccion_transparencia/articulo_29/fraccion_4/'+archivos[i][1]+'"><img src="images/iconos/icon_descargar.png" style="width:25px"></a></center>'+
                                                '</td>'+
                                                '<td id="td3_3">'+
                                                    '<center>'+
                                            ...
                                            '<div id="f4_1_modal'+(i+1)+'" class="modal modal-fixed-footer">'+
                                                '<div class="modal-content">'+
                                                    '<blockquote><h2>'+archivos[i][0]+'</h2></blockquote>'+
                                                    '<embed src="archivos/seccion_transparencia/articulo_29/fraccion_4/'+archivos[i][1]+'" type="application/pdf" style="width:100%; height: 500px;" />'+
                                                '</div>'+
                                                '<div class="modal-footer">'+
                                                    '<a style="color:white" class="modal-close w3-btn w3-block middleblue">Cerrar <img style="width:20px;vertical-align:middle;" src="images/iconos/icon_cerrar.png"></a>'+
                                                '</div>'+
            ...
            <?php
                    ...
                    case 5:
            ?>
                        <blockquote><h2>Fracción V. Indicadores De Interés Público O Social</h2></blockquote>
